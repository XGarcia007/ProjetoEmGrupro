...
namespace Testeprojeto.Controllers
{
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContatoId,Nome,Celular,Observacao")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ContatoId,Nome,Celular,Observacao")] Contato contato)
        {
